...
For information on hosting a static website in Amazon S3, see `Hosting a Static Website <https://docs.aws.amazon.com/AmazonS3/latest/dev/WebsiteHosting.html>`__ in the *Amazon Simple Storage Service Developer Guide*.